		...
		<s:form action="SaleReturn" id="product_form" theme="simple">
			...
			<table width="100%">
					...
					<tr style="display: ;">
						...
						<td width="2%">
							<s:textarea name="barcodeData" id="barcodeData" onchange="setBarcodeAjax(this.value)" />
						</td>
					...
					<td width="40%">
						...
						<table width="100%" style="border: 1px solid #e69623; height: auto; padding: 1em; " id="dropdowntable">
							...
							<tr>
								...
								<td align="center">:</td>
								<td><s:select onchange="setGenderAjaxSaleReturn(this.value)"  list="#{'0':'Select Gender','1':'Gents','2':'Ladies','3':'Accessories'}" theme="simple" name="gender" id="gender" /></td>
							</tr>
							<tr>
						...
						<table width="100%">
							<tr>
								<td><input type="submit" value=" Next to Retrun Sale " id="billbtn"></td>
							</tr>
						</table>
					</td>
