...
<div id="login_main" class="main_layout_content">
	<h2 class="heading" >Sale Account of <s:property value="customerName"/> (Mob : <s:property value="mobileNumber"/>)</h2>
	...
	<div id="login" class="block_div">
		...
		<span class="error"><s:actionerror id="server_side_error"/></span>
			...
			<s:form action="accountInvoiceReport" theme="simple">
				...
				<table id="results" cellpadding="0" cellspacing="0" class="my-table"  style="width:100%;">
					<tr>
						...
						<th style="background:transparent url('common/images/table_header.gif') no-repeat scroll 0 0;">Vat %</th>
					...
					<s:iterator value="saleaccList">
						<tr>
							<td><s:property value="date"/></td>
							<td><a href="viewinvoiceSale?invoiceid=<s:property value="id"/>"><s:property value="id"/></a></td>
							<s:if test="balance>0">
								<td><a href="recordInvoiceReport?invoiceid=<s:property value="id"/>"> (Record Payment)</a></td>
							</s:if>
							<s:else>
								<td>Paid</td>
							</s:else>
							...
							<td>Rs.<s:property value="rupee"/></td>
					...
					<tr>
					   ...
					   <td></td>
					   <td></td>
					   <td style="font-weight: bold;"><s:property value="debitx"/></td>
					   <td></td>
					   <td></td>
					   <td style="font-weight: bold;"><s:property value="creditx"/></td>
					   <td style="font-weight: bold;"><s:property value="balance"/></td>
