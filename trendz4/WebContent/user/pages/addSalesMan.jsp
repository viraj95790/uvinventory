...
<script type="text/javascript" src="user/js/salesman.js"></script>
<div id="login_main" class="main_layout_content">
	<h2 class="heading" >Add SalesMan</h2>
	<span id="mandatory_message" class="error">Note:Fields marked with asterisk(*) are required.</span> 
	<div id="login" class="block_div">
		
		<span class="error"><s:actionerror id="server_side_error"/></span>
		<s:form action='saveSalesMan' method='POST' id="salesmanfrm" theme="simple">
